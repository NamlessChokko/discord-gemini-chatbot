...
import { validReply, botShouldReply, substituteMentionUsernames, substituteNamesWithMentions, createHistory, formatUsageMetadata, createParts, devideLongMessages, sendTypingIndicator } from '../lib/utils.js';
export var name = 'messageCreate';
export function execute(message, gemini, client) {
    return _async_to_generator(function() {
        var _message_guild, _message_author, _message_author1, _client_user, _client_user1, _response_candidates_, _response_candidates, currentTime, location, authorName, botName, prompt, content, systemInstruction, history, chat, response, _, _tmp, error, responseText, modelVersion, usageMetadata, finishReason, longMessages, firstMessage, lastReply, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _$message, newReply, err, finalResponse;
