...
export function execute(interaction) {
    return _async_to_generator(function() {
        var _interaction_guild;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    newHelpCommandLog(new Date().toLocaleString(), interaction.user.username, ((_interaction_guild = interaction.guild) === null || _interaction_guild === void 0 ? void 0 : _interaction_guild.name) || 'DM');
                    return [
                        4,
